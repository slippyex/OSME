 ...
 *
 * $Id: mfpemul.h,v 2.1 2003/10/11 04:40:25 benjihan Exp $
 */
...
#include "emu68/struct68.h"
  ...
  typedef unsigned int addr68_t;
  typedef unsigned int uint68_t;


  typedef int68_t interrupt68_t ;
 ...
 */
int mfp_get_tdr(mfp_t * const mfp, const int timer, const bogoc68_t bogoc);
...
void mfp_put_tdr(mfp_t * const mfp,
		 const int timer, const int v, const bogoc68_t bogoc);
