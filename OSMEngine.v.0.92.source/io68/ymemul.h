 ...
 *
 * $Id: ymemul.h,v 2.2 2003/10/11 04:40:25 benjihan Exp $
 */
...
/** Yamaha get buffer.
 *
 *    The YM_getbuffer() function returns a pointer to the current PCM
 ...
 *          -bit#0: canal A (0:off 1:on)
 *          -bit#1: canal B (0:off 1:on)
 *          -bit#2: canal C (0:off 1:on)
 *
 ...
 *              -bit#2: canal C (0:off 1:on)
 *
 *  @see void YM_get_active_voices(int v);
 */
